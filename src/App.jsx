    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ width: 40, height: 40, border: '3px solid #334155', borderTopColor: '#60a5fa', borderRadius: '50%', animation: 'spin 1s linear infinite', margin: '0 auto 16px' }} />
            ...
            {news.map(item => (
              <li key={item.id}>
                <a
                  ...
                  style={{ display: 'block', padding: '16px 20px', background: '#1e293b', borderRadius: 10, textDecoration: 'none', color: 'inherit', transition: 'background 0.2s' }}
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: '#64748b' }}>
                    <span style={{ color: currentBrand?.brandColor || '#60a5fa', marginRight: 8 }}>{item.source}</span>
