...
function App() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 20, fontFamily: 'system-ui, sans-serif' }}>
        ...
        {data.brands.map(brand => (
          <button
            ...
            style={{
              ...
              backgroundColor: activeBrand === brand.brandKey ? (BRAND_COLORS[brand.brandKey] || '#333') : '#f0f0f0',
              transition: 'all 0.2s'
            }}
          >
            {brand.brandName}
      ...
      {currentBrand && (
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16, color: BRAND_COLORS[currentBrand.brandKey] || '#333' }}>
